import { Scene } from './Flip/FlipFluidScene';

/*
 * This class is for handling the physics used in the fluid simulation 
 * This includes the grid used in the Eulerian system 
 */ 
...
export class FluidPhysics {
  ...
  s: Float32Array; // Solidness array -> 0 = solid, 1 = fluid
  m: Float32Array; // Smoke density array -> 0 = black, 1 = white
